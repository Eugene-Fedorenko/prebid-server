...
## Standards
Anyone is free to review and comment on any [open pull requests](https://github.com/eugene-fedorenko/prebid-server/pulls).
...
- Is the motivation behind these changes clear? If not, there must be [an issue](https://github.com/eugene-fedorenko/prebid-server/issues) explaining it. Are there better ways to achieve those goals?
