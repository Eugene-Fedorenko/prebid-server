...
[Create an issue](https://github.com/eugene-fedorenko/prebid-server/issues/new) describing the motivation for your changes.
...
against the `master` branch of [our GitHub repository](https://github.com/eugene-fedorenko/prebid-server/compare).
...
**Note**: We also have some [known intermittent failures](https://github.com/eugene-fedorenko/prebid-server/issues/103).
