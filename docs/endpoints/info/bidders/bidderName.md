...
- `maintainer.email`: A contact email for the Bidder's maintainer. In general, Bidder bugs should be logged as [issues](https://github.com/eugene-fedorenko/prebid-server/issues)... but this contact email may be useful in case of emergency.
