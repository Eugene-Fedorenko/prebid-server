...
import (
	...
	"github.com/eugene-fedorenko/prebid-server/cache/filecache"
	"github.com/eugene-fedorenko/prebid-server/cache/postgrescache"
	"github.com/eugene-fedorenko/prebid-server/config"
	"github.com/eugene-fedorenko/prebid-server/endpoints"
	infoEndpoints "github.com/eugene-fedorenko/prebid-server/endpoints/info"
	"github.com/eugene-fedorenko/prebid-server/endpoints/openrtb2"
	"github.com/eugene-fedorenko/prebid-server/exchange"
	"github.com/eugene-fedorenko/prebid-server/gdpr"
	metricsConf "github.com/eugene-fedorenko/prebid-server/metrics/config"
	"github.com/eugene-fedorenko/prebid-server/openrtb_ext"
	"github.com/eugene-fedorenko/prebid-server/pbs"
	pbc "github.com/eugene-fedorenko/prebid-server/prebid_cache_client"
	"github.com/eugene-fedorenko/prebid-server/router/aspects"
...
func newExchangeMap(cfg *config.Configuration) map[string]adapters.Adapter {
	...
	return map[string]adapters.Adapter{
		...
		"rubicon_spot": rubicon.NewRubiconLegacyAdapter(adapters.DefaultHTTPAdapterConfig, cfg.Adapters[string(openrtb_ext.BidderRubiconSpot)].Endpoint,
			cfg.Adapters[string(openrtb_ext.BidderRubiconSpot)].XAPI.Username, cfg.Adapters[string(openrtb_ext.BidderRubiconSpot)].XAPI.Password, cfg.Adapters[string(openrtb_ext.BidderRubiconSpot)].XAPI.Tracker),
