...
func (a *TtxAdapter) makeRequest(request openrtb.BidRequest, imp openrtb.Imp) (*adapters.RequestData, error) {
	impCopy, extBidder, err := makeImps(imp)
...
func makeImps(imp openrtb.Imp) (*openrtb.Imp, *openrtb_ext.ExtImp33across, error) {
	if imp.Banner == nil && imp.Video == nil {
		return nil, nil, &errortypes.BadInput{
