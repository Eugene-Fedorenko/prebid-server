...
func SetupViper(v *viper.Viper, filename string) {
	...
	v.SetDefault("adapters.rubicon_spot.disabled", false)
	v.SetDefault("adapters.rubicon_spot.endpoint", "http://exapi-us-east.rubiconproject.com/a/api/exchange.json")
	...
	v.SetDefault("adapters.verizonmedia.endpoint", "http://example.com")
