...
import (
	...
	metricsConfig "github.com/eugene-fedorenko/prebid-server/metrics/config"
	...
	"github.com/eugene-fedorenko/prebid-server/stored_requests/backends/file_fetcher"
...
// 	   as specified in https://github.com/eugene-fedorenko/prebid-server/issues/465
...
// 	   sample request as specified in https://github.com/eugene-fedorenko/prebid-server/issues/465
...
func TestCharacterEscape(t *testing.T) {
	...
	/*    https://github.com/eugene-fedorenko/prebid-server/issues/465	*/
	cfg := &config.Configuration{
	...
	//An openrtb.BidRequest struct as specified in https://github.com/eugene-fedorenko/prebid-server/issues/465
...
func TestApplyDealSupport(t *testing.T) {
	...
	for _, test := range testCases {
		...
		bid := pbsOrtbBid{&openrtb.Bid{ID: "123456"}, "video", map[string]string{}, &openrtb_ext.ExtBidPrebidVideo{}, nil, test.dealPriority, false}
